import { DataCreateOrUpdateUser, Job, UserDataResult } from '@/app/types/types';
...
export async function createUser(
  ...
  try {
    ...
    throw new Error('User creation failed. Please try again later.'); // or handle it as needed
  }
}
